 ...
 *
 */
public class ToolVersionStruct {
   ...
   */
  public ToolVersionStruct(String version, String buildstamp, String name) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    ToolVersionStruct other = (ToolVersionStruct) obj;
    if (buildstamp == null) {
