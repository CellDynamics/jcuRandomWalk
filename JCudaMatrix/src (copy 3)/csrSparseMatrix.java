...
public class csrSparseMatrix {
	...
	public float [] LuSolve(denseVector b_gpuPtr, boolean iLuBiCGStabSolve){
		...
		if (iLuBiCGStabSolve){
			...
			float tol=5e-3f; // tolerance nrmr / nrmr0[0], which is size of current errors divided by initial error
			...
			jcuda.jcublas.JCublas2.cublasSscal (cublashandle, n ,  Pointer.to(minus_one_host), r , 1 ) ;
			jcuda.jcublas.JCublas2.cublasSaxpy (cublashandle, n , Pointer.to(one_host) , b_gpuPtr.getPtr(), 1 , r , 1 ) ;
			...
			jcuda.jcublas.JCublas2.cublasSnrm2 (cublashandle, n , r , 1 ,Pointer.to(nrmr0)) ;
			...
			for ( int i =0; i<maxit ; i++){
				...
				tttf[0]=alpha;
				jcuda.jcublas.JCublas2.cublasSaxpy (cublashandle, n , Pointer.to(tttf) , ph , 1 , x_gpuPtr , 1 ) ;
				...
				tttf[0]=omega;
				jcuda.jcublas.JCublas2.cublasSaxpy (cublashandle, n , Pointer.to(tttf) , s , 1 , x_gpuPtr , 1 ) ;
				...
				System.out.println("Here0 nrmr: "+nrmr +" nrmr0: "+nrmr0[0]+ " alpha: "+alpha+ " beta: "+beta+ " rho: "+rho+ " temp: "+temp2+ " temp: "+temp2+ " omega: "+omega);
