...
//printVector(v);
		...
		//create rhs vector so that a*[1,2,3]=v
		//float[] v={24.f, 0.f, 11.f};

		//unsymmetric, simple one seems alright
		//float[][] a={{1.f,7.f,5.f},{7.f,4.f,-5.f},{3.f,-5.f,6.f}};
		//create rhs vector so that a*[1,2,3]=v
		//float[] v={30.f, 0.f, 11.f};
...
float[] result = cu_A.LUsolve(cu_V); //method should be renamed according to matrix type
