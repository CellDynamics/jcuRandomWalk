...
//		// 2 : S e t p=r and \ t i l d e { r}=r
		...
		jcuda.jcublas.JCublas.cublasScopy ( n , r , 1 , p , 1 ) ;
		jcuda.jcublas.JCublas.cublasScopy ( n , r , 1 , rw , 1 ) ;
		nrmr0 = jcuda.jcublas.JCublas.cublasSnrm2 ( n , r , 1 ) ;
		...
		jcuda.jcublas.JCublas.cublasSaxpy ( n ,-omega , q , 1 , p , 1 ) ;
		jcuda.jcublas.JCublas.cublasSscal ( n , beta , p , 1 ) ;
		jcuda.jcublas.JCublas.cublasSaxpy ( n , 1.0f , r , 1 , p , 1 ) ;
		}
...
//		// 1 8 : s = r − \ a l p h a q		
//		
		jcuda.jcublas.JCublas.cublasSaxpy ( n ,-alpha , q , 1 , r , 1 ) ;
//		// 1 9 : x = x + \ a l p h a \ hat {p}
		jcuda.jcublas.JCublas.cublasSaxpy ( n , alpha , ph , 1 , cu_Y , 1 ) ;
//		// 2 0 : c h e c k f o r c o n v e r g e n c e
		 nrmr = jcuda.jcublas.JCublas.cublasSnrm2 ( n , r , 1 ) ;
		float tol=1e-3f;
...
//		// 2 5 : \omega = ( t ˆ{T} s ) / ( t ˆ{T} t )
		...
		omega= temp / temp2 ;
//		// 2 6 : x = x + \omega \ hat { s }
		jcuda.jcublas.JCublas.cublasSaxpy ( n , omega , s , 1 , cu_Y , 1 ) ;
...
//		// 2 7 : r = s − \omega t
		jcuda.jcublas.JCublas.cublasSaxpy ( n ,-omega , t , 1 , r , 1 ) ;
